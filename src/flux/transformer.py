...
def tranformer_forward(
    ...
    condition_latents_texture: torch.Tensor,
    condition_latents_texture_mask: torch.Tensor,
    ...
    **params: dict,
    ...
    if use_texture_image:
        condition_latents_texture = self.x_embedder(condition_latents_texture)  
    ###############
        ...
        if self.training and self.gradient_checkpointing:
            ...
            encoder_hidden_states, hidden_states, condition_latents = (
                torch.utils.checkpoint.checkpoint(
                    ...
                    use_texture_image=use_texture_image, #####modify#####
                    **ckpt_kwargs,
                )
            )
