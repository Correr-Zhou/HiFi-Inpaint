...
<div align="center">
  ...
  <a href="https://huggingface.co/donghao-zhou/HiFi-Inpaint/"><img src="https://img.shields.io/static/v1?label=Model&message=HiFi-Inpaint&color=yellow"></a>
</div>
...
1. Download the base model [FLUX.1-dev](https://huggingface.co/black-forest-labs/FLUX.1-dev) and our [LoRA weights](https://huggingface.co/donghao-zhou/HiFi-Inpaint/).
